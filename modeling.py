    ...
    def __init__(self,
        ...
        Raises:
          ValueError: The config is invalid or one of the input tensor shapes
            is invalid.
        """
        # 首先是对config(BertConfig对象)深度拷贝一份，如果不是训练，那么把dropout都置为零
        ...
        with tf.compat.v1.variable_scope(scope, default_name="bert"):
            ...
            with tf.compat.v1.variable_scope("encoder"):
                ...
                # 用transformer_model函数构造多个Transformer SubLayer然后stack在一起。得到的all_encoder_layers是一个list，
                # 长度为num_hidden_layers（默认12），每一层对应一个值。 每一个值都是一个shape为[batch_size, seq_length, hidden_size]的tensor。
            ...
            with tf.compat.v1.variable_scope("pooler"):
                ...
                # first_token_tensor是第一个Token([CLS])最后一层的输出
